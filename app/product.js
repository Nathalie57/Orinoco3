  ...
  templateSingle() {
    ...
    <div class="row" id="single-product">
      <div class="col-lg-6 mb-5">
        <a href="${this.imageUrl}" class="image-popup"><img src="${this.imageUrl}" class="img-fluid"
      ...
      <div class="col-lg-6 product-details pl-md-5">
        ...
        <p>
        <div class=" btn btn-primary py-3 px-5" onclick="orinoco['${this.ref}'].add()">Ajouter au panier
        </div>
