class Product extends Component {
    ...
    render(){
        const object = JSON.stringify({imageUrl: this.imageUrl,name: this.name,price: this.price,_id: this._id});
        this.DOM.innerHTML = this.resume ? this.templateResume() : this.templateSingle(object);
    }
